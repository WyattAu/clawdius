//! Wallet Guard Prototype
//!
//! Pre-trade risk check algorithm per YP-HFT-BROKER-001.
//!
...
pub const MAX_DRAWDOWN: i64 = 100_000_00;
...
mod tests {
    ...
    fn create_test_wallet() -> Wallet {
        let mut wallet = Wallet::new(1_000_000_00);
    ...
    fn test_daily_drawdown_exceeded() {
        ...
        wallet.realized_pnl = -110_000_00;
        ...
        match decision {
            RiskDecision::Reject(RejectReason::DailyDrawdownExceeded { current, max }) => {
                assert_eq!(current, 110_000_00);
                assert_eq!(max, 100_000_00);
            }
    ...
    fn test_drawdown_within_limit() {
        let mut wallet = Wallet::new(500_000_00);
