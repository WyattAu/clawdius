...
The elevator pitch: 122K lines of Rust, 318 Lean4 theorems proven correct, zero panics, zero compiler warnings, zero CVEs. Everything an AI coding assistant generates runs in isolated sandboxes — not raw shell access.

## Technical Highlights

- **Formal verification:** 318 Lean4 theorems covering ring buffers (2ns push, 1ns pop), wallet guards (16ns), and sandbox isolation. Zero `sorry` — 39 axioms only for external I/O/syscall boundaries.
